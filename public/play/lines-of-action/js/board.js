// Lines of Action -- SVG board renderer
...
export function initBoard(svgElement, onNodeClick) {
  ...
  // Board border
  squareLayer.appendChild(el('rect', {
    x: MARGIN, y: MARGIN, width: CELL * 8, height: CELL * 8,
  ...
  for (let f = 0; f < 8; f++) {
    const t = el('text', { x: MARGIN + f * CELL + CELL / 2, y: MARGIN + 8 * CELL + 18, 'text-anchor': 'middle' });
